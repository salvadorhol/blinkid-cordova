 ...
 *  }
 */
BlinkID.prototype.scanWithCamera = function (
  successCallback,
  errorCallback,
  overlaySettings,
  ...
  if (typeof errorCallback != "function") {
    console.log(
      "BlinkIDScanner.scanWithCamera failure: failure parameter not a function"
    );
    throw new Error(
      "BlinkIDScanner.scanWithCamera failure: failure parameter not a function"
    );
  ...
  if (typeof successCallback != "function") {
    console.log(
      "BlinkIDScanner.scanWithCamera failure: success callback parameter must be a function"
    );
    throw new Error(
      "BlinkIDScanner.scanWithCamera failure: success callback parameter must be a function"
    );
  ...
  exec(
    function internalCallback(scanningResult) {
      ...
      if (cancelled) {
        ...
        if (results.length != recognizerCollection.recognizerArray.length) {
          console.log(
            "INTERNAL ERROR: native plugin returned wrong number of results!"
          );
          throw new Error(
            "INTERNAL ERROR: native plugin returned wrong number of results!"
          );
          ...
          for (var i = 0; i < results.length; ++i) {
            ...
            recognizerCollection.recognizerArray[i].result =
              recognizerCollection.recognizerArray[i].createResultFromNative(
                results[i]
              );
          }
    ...
    "BlinkIDScanner",
    "scanWithCamera",
    [overlaySettings, recognizerCollection, licenses]
  );
};
...
BlinkID.prototype.scanWithDirectApi = function (
  successCallback,
  errorCallback,
  recognizerCollection,
  frontImage,
  ...
  if (typeof errorCallback != "function") {
    console.log(
      "BlinkIDScanner.scanWithDirectApi failure: failure parameter not a function"
    );
    throw new Error(
      "BlinkIDScanner.scanWithDirectApi failure: failure parameter not a function"
    );
  ...
  if (typeof successCallback != "function") {
    console.log(
      "BlinkIDScanner.scanWithDirectApi failure: success callback parameter must be a function"
    );
    throw new Error(
      "BlinkIDScanner.scanWithDirectApi failure: success callback parameter must be a function"
    );
  ...
  exec(
    ...
    "BlinkIDScanner",
    "scanWithDirectApi",
    [recognizerCollection, frontImage, backImage, licenses]
  );
};
...
function RecognizerCollection(recognizerArray) {
  ...
  for (var i = 0; i < this.recognizerArray.length; ++i) {
    if (!(this.recognizerArray[i] instanceof Recognizer)) {
      throw new Error(
        "Each element in recognizerArray must be instance of Recognizer"
      );
    }
  }
}
...
function ImageAnalysisResult(nativeImageAnalysisResult) {
  ...
  this.documentImageColorStatus =
    nativeImageAnalysisResult.documentImageColorStatus;
  /** The Moire pattern detection status determined from the scanned image. */
  this.documentImageMoireStatus =
    nativeImageAnalysisResult.documentImageMoireStatus;
  ...
  this.barcodeDetectionStatus =
    nativeImageAnalysisResult.barcodeDetectionStatus;
...
function BarcodeResult(nativeBarcodeResult) {
  ...
  this.dateOfBirth =
    nativeBarcodeResult.dateOfBirth != null
      ? new Date(nativeBarcodeResult.dateOfBirth)
      : null;

  /** The date of issue of the document. */
  this.dateOfIssue =
    nativeBarcodeResult.dateOfIssue.Date != null
      ? new Date(nativeBarcodeResult.dateOfIssue)
      : null;

  /** The date of expiry of the document. */
  this.dateOfExpiry =
    nativeBarcodeResult.dateOfExpiry.Date != null
      ? new Date(nativeBarcodeResult.dateOfExpiry)
      : null;
  ...
  this.driverLicenseDetailedInfo =
    nativeBarcodeResult.driverLicenseDetailedInfo != null
      ? new BarcodeDriverLicenseDetailedInfo(
          nativeBarcodeResult.driverLicenseDetailedInfo
        )
      : null;
  ...
  this.extendedElements =
    nativeBarcodeResult.extendedElements != null
      ? new BarcodeElements(nativeBarcodeResult.extendedElements)
      : null;
}
...
function VizResult(nativeVizResult) {
  ...
  /** The date of birth of the document owner. */
  this.dateOfBirth =
    nativeVizResult.dateOfBirth.Date != null
      ? new Date(nativeVizResult.dateOfBirth)
      : null;

  /** The date of issue of the document. */
  this.dateOfIssue =
    nativeVizResult.dateOfIssue.Date != null
      ? new Date(nativeVizResult.dateOfIssue)
      : null;

  /** The date of expiry of the document. */
  this.dateOfExpiry =
    nativeVizResult.dateOfExpiry.Date != null
      ? new Date(nativeVizResult.dateOfExpiry)
      : null;
  ...
  this.driverLicenseDetailedInfo =
    nativeVizResult.driverLicenseDetailedInfo != null
      ? new DriverLicenseDetailedInfo(nativeVizResult.driverLicenseDetailedInfo)
      : null;
...
function MrzResult(nativeMRZResult) {
  ...
  this.dateOfBirth =
    nativeMRZResult.dateOfBirth != null
      ? new Date(nativeMRZResult.dateOfBirth)
      : null;
  /**
  ...
  this.dateOfExpiry =
    nativeMRZResult.dateOfExpiry != null
      ? new Date(nativeMRZResult.dateOfExpiry)
      : null;
  /**
...
BlinkID.prototype.DocumentNumberAnonymizationSettings =
...
BlinkID.prototype.DocumentVerificationOverlaySettings =
...
function BlinkIdOverlaySettings() {
   ...
   */
  this.androidCameraResolutionPreset =
...
SuccessFrameGrabberRecognizerResult.prototype = new RecognizerResult(
  RecognizerResultState.empty
);

BlinkID.prototype.SuccessFrameGrabberRecognizerResult =
...
function SuccessFrameGrabberRecognizer(slaveRecognizer) {
  ...
  this.createResultFromNative = function (nativeResult) {
    this.slaveRecognizer.result = this.slaveRecognizer.createResultFromNative(
      nativeResult.slaveRecognizerResult
    );
    return new SuccessFrameGrabberRecognizerResult(nativeResult);
  }.bind(this);
}

SuccessFrameGrabberRecognizer.prototype = new Recognizer(
...
function BlinkIdMultiSideRecognizerResult(nativeResult) {
  ...
  this.additionalOptionalAddressInformation =
    nativeResult.additionalOptionalAddressInformation;
   ...
   */
  this.dateOfBirth =
    nativeResult.dateOfBirth != null
      ? new Date(nativeResult.dateOfBirth)
      : null;
   ...
   */
  this.dateOfExpiry =
    nativeResult.dateOfExpiry != null
      ? new Date(nativeResult.dateOfExpiry)
      : null;
   ...
   */
  this.dateOfIssue =
    nativeResult.dateOfIssue != null
      ? new Date(nativeResult.dateOfIssue)
      : null;
   ...
   */
  this.documentOptionalAdditionalNumber =
    nativeResult.documentOptionalAdditionalNumber;
   ...
   */
  this.frontAdditionalProcessingInfo =
    nativeResult.frontAdditionalProcessingInfo;
   ...
   */
  this.mrzResult =
    nativeResult.mrzResult != null
      ? new MrzResult(nativeResult.mrzResult)
      : null;
...
BlinkIdMultiSideRecognizerResult.prototype = new RecognizerResult(
  RecognizerResultState.empty
);

BlinkID.prototype.BlinkIdMultiSideRecognizerResult =
...
function BlinkIdMultiSideRecognizer() {
  ...
  this.createResultFromNative = function (nativeResult) {
    return new BlinkIdMultiSideRecognizerResult(nativeResult);
  };
}

BlinkIdMultiSideRecognizer.prototype = new Recognizer(
...
BlinkIdSingleSideRecognizerResult.prototype = new RecognizerResult(
  RecognizerResultState.empty
);

BlinkID.prototype.BlinkIdSingleSideRecognizerResult =
...
function BlinkIdSingleSideRecognizer() {
  ...
  this.createResultFromNative = function (nativeResult) {
    return new BlinkIdSingleSideRecognizerResult(nativeResult);
  };
}

BlinkIdSingleSideRecognizer.prototype = new Recognizer(
...
function DocumentFaceRecognizerResult(nativeResult) {
  ...
  this.documentLocation =
    nativeResult.documentLocation != null
      ? new Quadrilateral(nativeResult.documentLocation)
      : null;
   ...
   */
  this.faceLocation =
    nativeResult.faceLocation != null
      ? new Quadrilateral(nativeResult.faceLocation)
      : null;
...
DocumentFaceRecognizerResult.prototype = new RecognizerResult(
  RecognizerResultState.empty
);
...
function DocumentFaceRecognizer() {
  ...
  this.createResultFromNative = function (nativeResult) {
    return new DocumentFaceRecognizerResult(nativeResult);
  };
}
...
IdBarcodeRecognizerResult.prototype = new RecognizerResult(
  RecognizerResultState.empty
);
...
function IdBarcodeRecognizer() {
  ...
  this.createResultFromNative = function (nativeResult) {
    return new IdBarcodeRecognizerResult(nativeResult);
  };
}
...
MrtdCombinedRecognizerResult.prototype = new RecognizerResult(
  RecognizerResultState.empty
);
...
function MrtdCombinedRecognizer() {
  ...
  this.createResultFromNative = function (nativeResult) {
    return new MrtdCombinedRecognizerResult(nativeResult);
  };
}
...
MrtdRecognizerResult.prototype = new RecognizerResult(
  RecognizerResultState.empty
);
...
function MrtdRecognizer() {
  ...
  this.createResultFromNative = function (nativeResult) {
    return new MrtdRecognizerResult(nativeResult);
  };
}
...
PassportRecognizerResult.prototype = new RecognizerResult(
  RecognizerResultState.empty
);
...
function PassportRecognizer() {
  ...
  this.createResultFromNative = function (nativeResult) {
    return new PassportRecognizerResult(nativeResult);
  };
}
...
VisaRecognizerResult.prototype = new RecognizerResult(
  RecognizerResultState.empty
);
...
function VisaRecognizer() {
  ...
  this.createResultFromNative = function (nativeResult) {
    return new VisaRecognizerResult(nativeResult);
  };
}
...
UsdlRecognizerResult.prototype = new RecognizerResult(
  RecognizerResultState.empty
);
...
function UsdlRecognizer() {
  ...
  this.createResultFromNative = function (nativeResult) {
    return new UsdlRecognizerResult(nativeResult);
  };
}
...
UsdlCombinedRecognizerResult.prototype = new RecognizerResult(
  RecognizerResultState.empty
);
...
function UsdlCombinedRecognizer() {
  ...
  this.createResultFromNative = function (nativeResult) {
    return new UsdlCombinedRecognizerResult(nativeResult);
  };
}
